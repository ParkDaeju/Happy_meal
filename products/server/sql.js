module.exports = {
    ...
    productModify1 : {
        query: `update t_product set product_name=? where id=?`
    },
    productModify2 : {
        query: `update t_product set product_price=? where id=?`
    },
    productModify3 : {
        query: `update t_product set delivery_price=? where id=?`
    },
    productModify4 : {
        query: `update t_product set add_delivery_price=? where id=?`
    },
    productModify5 : {
        query: `update t_product set tags=? where id=?`
    },
    productModify6 : {
        query: `update t_product set outbound_days=? where id=?`
    }
}